  ...
  for (let i = 0; i < embeds.length; i++) {
    try {
      ...
      if (html) {
        ...
        const section = `<div class="mb-10"><a class="bg-white overflow-hidden shadow-lg shadow-secondary-500/40 rounded-lg px-4 py-6" href="${embeds[i].url}" target="_blank" rel="noreferrer">${result.title}</a></div>`;
