        ...
        <div className="mb-14">
          <div className="text-white bg-gray-900 px-6 py-3 rounded-md">
            <a className="" href="${embeds[i].url}" target="_blank" rel="noreferrer">
              <p className="text-white font-bold mb-1 mt-0">${result?.twitter_card?.title || result?.title}</p>
              <p className="text-white text-sm m-0">${result?.twitter_card?.description}</p>
            </a>
          </div>
        </div>`;
